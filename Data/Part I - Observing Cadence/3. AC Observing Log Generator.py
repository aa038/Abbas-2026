...
CONTRAST_FLOOR = 4e-11        # Contrast floor for this fiducial-case directory
...
MCMC_STEPS     = 200000         # No of orbit steps taken by the MCMC sampler (Time complexity scales as O(N)) 
