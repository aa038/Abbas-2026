...
mock_survey = pd.read_csv(os.path.join(curr_dir, '1g. Mock Survey.csv'))
...
plt.savefig(curr_dir / "1h. Survey Results.png", bbox_inches = 'tight', dpi = 300)
