...
planets_df = pd.read_csv(curr_dir / "2d. Detected Planets.csv")
...
mock_survey = pd.read_csv(os.path.join(curr_dir, '2g. Mock Survey.csv'))
...
plt.savefig(curr_dir / "2h. Survey Results.png", bbox_inches = 'tight', dpi = 300)
