...
Input:
    5a. Adaptive Cadence - Observing Log.csv       # The observing log for te fiducial configuration generated with an adaptive cadence


Output:
    5b. 4D Tongue Plot.npz                         # The 4D tongue plot stored as a .npz file
"""
...
# Forecaster for radius-mass conversions
