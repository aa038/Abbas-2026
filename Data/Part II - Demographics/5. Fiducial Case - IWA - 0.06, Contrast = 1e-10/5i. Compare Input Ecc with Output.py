"""
Input Ecc Dist vs MCMC Fit (Part 9 of 9)
-------------------------------------------
...
Input:
    ...
    5e. Fit, N = 1e4.csv                   # The full list of MCMC posteriors (From Part 5)


Output:
    5i. Input Ecc vs Output Ecc.png        # Plot of the Ecc Distributions
"""
...
plt.legend()
plt.savefig(curr_dir / "5i. Input Ecc vs Output Ecc.png", dpi = 300, bbox_inches = 'tight')