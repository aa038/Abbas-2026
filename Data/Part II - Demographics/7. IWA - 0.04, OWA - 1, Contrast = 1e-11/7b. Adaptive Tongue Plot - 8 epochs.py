...
Input:
    7a. Adaptive Cadence - Observing Log.csv       # The observing log for te fiducial configuration generated with an adaptive cadence


Output:
    7b. 4D Tongue Plot.npz                         # The 4D tongue plot stored as a .npz file
"""
...
forecaster_dir = curr_dir.parent.parent / "Forecaster"
...
RADIUS_LIMS          = [0.5, 3.4]     # Minimum and maximum planet radius in Earth radii (R_E)
...
def EpochOfPeriastronPassage(P, missionStart, num_planets):
    ...
    Returns:
    epochs_of_periastron (float or np.array): Epoch of periastron passage in years.
    """
...
if __name__ == '__main__':
    ...
    obslog = pd.read_csv(curr_dir / '7a. Observing Log.csv')
    ...
    np.savez(
    curr_dir / '7b. 4D Tongue Plot.npz',
