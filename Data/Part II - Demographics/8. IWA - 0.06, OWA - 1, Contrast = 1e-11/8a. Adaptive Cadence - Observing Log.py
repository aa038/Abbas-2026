...
Output:
    8a. Observing Log.csv                                 # The observing log for the chosen telescope configuration
"""
...
def run_mission(save_csv=True, verbose=True):
    ...
    if save_csv:
        ...
        out.to_csv(curr_dir / "8a. Observing Log.csv", index=False)
        if verbose:
            print(f"\nSaved {len(out)} rows to 8a. Observing Log.csv")
