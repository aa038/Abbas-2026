...
Input:
    8b. 4D Tongue Plot.npz              # The 4D tongue plot stored a 4D NumPy array (From Part b)
    8d. Planet Posterior Samples.csv    # Final Orbituary P/e posterior samples (From Part d)


Output:
    8e. Fit, N = 1e4.csv                # The full list of MCMC posteriors for each parameter in the OR model
"""
...
posterior_samples_file = joinpath(curr_dir, "8d. Planet Posterior Samples.csv")
