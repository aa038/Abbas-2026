...
planets_df = pd.read_csv(curr_dir / "8d. Detected Planets.csv")
...
mock_survey = pd.read_csv(os.path.join(curr_dir, '8g. Mock Survey.csv'))
...
plt.savefig(curr_dir / "8h. Survey Results.png", bbox_inches = 'tight', dpi = 300)
