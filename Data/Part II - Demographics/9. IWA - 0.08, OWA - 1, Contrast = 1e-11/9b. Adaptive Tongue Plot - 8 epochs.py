...
Input:
    9a. Adaptive Cadence - Observing Log.csv       # The observing log for te fiducial configuration generated with an adaptive cadence


Output:
    9b. 4D Tongue Plot.npz                         # The 4D tongue plot stored as a .npz file
"""
...
if __name__ == '__main__':
    ...
    obslog = pd.read_csv(curr_dir / '9a. Observing Log.csv')
    ...
    np.savez(
    curr_dir / '9b. 4D Tongue Plot.npz',
