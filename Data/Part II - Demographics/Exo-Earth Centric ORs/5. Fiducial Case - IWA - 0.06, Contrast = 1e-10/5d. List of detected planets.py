...
Input:
    5a. Observing Log.csv               # The observing log for the chosen telescope configuration (from Part a)
    5c. Orbit Fits.pkl                  # Orbituary posteriors from Part c
...
print(f"Saved {len(posterior_samples)} posterior samples for {posterior_samples['PlanetID'].nunique()} planets to 5d. Planet Posterior Samples.csv")