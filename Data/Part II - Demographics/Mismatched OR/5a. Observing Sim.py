...
def IntegrationTime(L, d, A, throughput = 0.27, contrast = 1e-10, SNR = 10, wavelength = 0.6e-6):
...
def contrastCheck(DetParams, albedo, Rp, coronagraphContrast = 1e-10):
...
def sepCheck(DetParams, IWA = 0.06, OWA = 1):
...
def SNRCheck(L, d, Rp, albedo, A, tExp, DetParams, wavelength = 0.6e-6, throughput = 0.27, contrast = 1e-10):
...
print(planets_df['sma_AU'].min())
print(planets_df['sma_AU'].max())
