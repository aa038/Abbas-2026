...
def generate_survey_completeness(stars_df, mass_centers, sma_centers, ecc_centers, num_planets_per_cell=10000):
    """
...
if __name__ == '__main__':
    ...
    mass_min = 0.01  # Minimum planet mass in Earth masses (M⊕)
    mass_max = 100.0  # Maximum planet mass in Earth masses (M⊕)
    sma_min = 0.1   # Minimum semi-major axis in AU
    sma_max = 10.0  # Maximum semi-major axis in AU
    ecc_min = 1e-4
    ecc_max = 0.99
    ...
    plt.tight_layout()
    plt.savefig(curr_dir / '1. Tongue Plot.png', dpi=300, bbox_inches='tight')
    plt.show()
