"""
Mock Survey CDF Plots (Part 8 of 9)
-------------------------------------------
Script to plot the the mock survey CDFs

Input:
    5d. Detected Planets.csv      # List of detected planets (From Part 4)
    5g. Mock Survey.csv           # The full list of mock surveys (From Part 7)


Output:
    5h. Survey Results.png        # Plot of the CDFs
"""
...
mock_survey = pd.read_csv(curr_dir / '5g. Mock Survey.csv')
# ------------------------------------------------------------------------------ #
...
axs[5].yaxis.set_major_locator(ticker.MultipleLocator(20))
axs[5].yaxis.set_minor_locator(ticker.MultipleLocator(10))
# ---------------------------------------------------------------------------- #
