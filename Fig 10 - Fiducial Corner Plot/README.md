# Figure 10 -- Fiducial Corner Plot
This folder reproduces **Figure 10** from Abbas et al. (2026, ApJ), generating a corner plot for the results of the MCMC occurrence rate fit.

## Files
- `Corner Plot.py`  -- Script to generate Fig 10
- `fig10_CornerPlot.png` -- Output figure for the 2.5e-11 contrast floor (matches Fig 10 in the paper).
...
- The results of all these scripts are provided as data products in the directory ``Data/Part II - Demographics/5. Fiducial Case - IWA - 0.06, Contrast = 1e-10`. `Corner Plot.py` references these and can thus be run directly to reproduce Fig 10.
...
```bash
python "Fig 10 - Fiducial Corner Plot/Corner Plot.py"
```
This will regenerate `fig10_CornerPlot.png`