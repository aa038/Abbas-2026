...
Output:
    fig11_CornerPlot.png         # Corner plot for the posteriors
"""
...
df['eta_Earth'] = df['eta_Earth'] * (2.35 ** beta_plus_one - 0.65 ** beta_plus_one) / (total_period_range[1] ** beta_plus_one - total_period_range[0] ** beta_plus_one)
...
plt.savefig(curr_dir / 'fig11_CornerPlot.png', dpi=300, bbox_inches='tight')
