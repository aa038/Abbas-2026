# Figure 12 -- 3x3 tongue plots
This folder reproduces **Figure 12** from Abbas et al. (2026, ApJ).
...
## Files
- `3x3 Plot - Tongue Plot with Planets.py`  -- Script to generate Fig 12
- `fig12_3x3_tplot.png` -- Output figure (matches Fig 12 in the paper).
...
- The results of all these scripts are provided as data products in the directory `Data/Part II - Demographics/1-9.`. `3x3 Plot - Tongue Plot with Planets.py` references these and can thus be run directly to reproduce Fig 12.
...
```bash
python "Fig 12 - 3x3 Tongue Plots/3x3 Plot - Tongue Plot with Planets.py"
```
This will regenerate `fig12_3x3_tplot.png`