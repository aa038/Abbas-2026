...
-------------------------------------------
Script to plot the mock survey CDFs
...
Input:
    ...
    Data/Part II - Demographics/5. Fiducial Case - IWA - 0.06, Contrast = 1e-10/5g. Mock Survey.csv           # The full list of mock surveys (From Part 7)


Output:
    fig12_CumulativeDist.png        # Plot of the CDFs
"""
import numpy as np
import pandas as pd
...
plt.savefig(curr_dir / "fig12_CumulativeDist.png", bbox_inches = 'tight', dpi = 300)
