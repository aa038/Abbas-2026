...
Output:
    fig13_3x3_ORPlot.png      # Matches Fig 13
"""
...
for idx, run_dir_name in enumerate(run_dirs):
    ...
    ax.axvline(x = 3.98, ls = "--", color = 'red')
...
# Save the figure
plt.savefig(curr_dir / 'fig13_3x3_ORPlot.png', dpi=300, bbox_inches='tight')
plt.show()