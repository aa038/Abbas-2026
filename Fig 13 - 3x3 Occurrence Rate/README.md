...
## Files
- `3x3 Plot - OR Histograms.py`  -- Script to generate Fig 13
- `fig13_3x3_ORPlot.png` -- Output figure (matches Fig 13 in the paper).
...
- The results of all these scripts are provided as data products in the directory `Data/Part II - Demographics/1-9.`. `3x3 Plot - OR Histograms.py` references these and can thus be run directly to reproduce Fig 13.
...
```bash
python "Fig 13 - 3x3 Occurrence Rate/3x3 Plot - OR Histograms.py"
```
This will regenerate `fig13_3x3_ORPlot.png`