...
## Files
- `3x3 Plot - Tongue Plot with Planets`  -- Script to generate Fig 14
- `fig14_3x3_tplot.png` -- Output figure (matches Fig 12 in the paper).
...
- The results of all these scripts are provided as data products in the directory `Data/Part II - Demographics/1-9.`. `3x3 Plot - Tongue Plot with Planets.py` references these and can thus be run directly to reproduce Fig 14.
...
```bash
python "Fig 14 - 3x3 Tongue Plots/3x3 Plot - Tongue Plot with Planets.py"
```
This will regenerate `fig14_3x3_tplot.png`