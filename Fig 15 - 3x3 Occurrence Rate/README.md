# Figure 15 -- 3x3 OR Distribution
This folder reproduces **Figure 15** from Abbas et al. (2026, ApJ).
...
## Files
- `3x3 Plot - OR Histograms`  -- Script to generate Fig 15
- `fig15_3x3_ORPlot.png` -- Output figure (matches Fig 15 in the paper).
...
- The results of all these scripts are provided as data products in the directory `Data/Part II - Demographics/1-9.`. `3x3 Plot - OR Histograms.py` references these and can thus be run directly to reproduce Fig 15.
...
```bash
python "Fig 15 - 3x3 Occurrence Rate/3x3 Plot - OR Histograms.py"
```
This will regenerate `fig15_3x3_ORPlot.png`