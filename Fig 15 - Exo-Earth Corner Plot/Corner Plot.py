...
Input:
    Data/Part II - Demographics/Exo-Earth Centric ORs/5. Fiducial Case - IWA - 0.06, Contrast = 1e-10/5e. Fit, N = 1e4.csv        # The full list of MCMC posteriors for each parameter in the OR model (From Part 5)


Output:
    fig15_ExoEarth_CornerPlot.png         # Corner plot for the posteriors
"""
...
plt.savefig(curr_dir / 'fig15_ExoEarth_CornerPlot.png', dpi=300, bbox_inches='tight')
