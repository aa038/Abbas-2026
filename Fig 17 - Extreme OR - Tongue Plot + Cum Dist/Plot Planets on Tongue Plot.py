...
for an exaggerated occurrence rate

Input:
    Data/Part II - Demographics/Scaled Occurrence Rates/5. IWA - 0.06, OWA - 1, Contrast = 1e-10/4D Tongue Plot.npz     # The 4D tongue plot data file for the fiducial IWA/CF
    Data/Part II - Demographics/Scaled Occurrence Rates/5. IWA - 0.06, OWA - 1, Contrast = 1e-10/5a. Observing Log.csv   # Observing log for the exaggerated IWA/CF

Output:
    fig17a_EOR_tplot.png      # Matches Fig 17a
"""
...
star_contours = [1, 5, 10, 20, 40, 60, 80, 90, 92]      # Number of stars for which contour lines are drawn
...
plt.savefig(curr_dir / 'fig17a_EOR_tplot.png', dpi=300, bbox_inches='tight')