...
Output:
    fig18_MismatchedModel.png        # Plot of the CDFs
"""
import numpy as np
import pandas as pd
...
# Convert planet mass to radius using Forecaster
mock_survey['planet_rad'] = optimized_mass_to_radius(mock_survey['planet_mass'])
# ------------------------------------------------------------------------------ #
...
plt.savefig(curr_dir / "fig18_MismatchedModel.png", bbox_inches = 'tight', dpi = 300)
