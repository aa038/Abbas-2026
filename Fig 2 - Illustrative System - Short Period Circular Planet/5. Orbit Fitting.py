"""
Orbit fitting and plotting the results (Fig 2 in Abbas et al. 2026) (Part 5 of 5)
---------------------------------------------------
...
Outputs:
    fig2a_OrbitalFit_SC.png           # If "3. Observing Log.csv" is used

    OR

    fig2b_OrbitalFit_AC.png           # If "4. Observing Log.csv" is used
"""
...
OBS_LOG_FILE  = "4. Observing Log.csv"   # 3 = Uniform Cadence, 4 = Adaptive Cadence
...
if OBS_LOG_FILE[0] == '3':
    ...
    SAVE_PATH = "fig2a_OrbitalFit_SC"

elif OBS_LOG_FILE[0] == '4':
    FIG_TITLE = "Adaptive Cadence"
    SAVE_PATH = "fig2b_OrbitalFit_AC"
