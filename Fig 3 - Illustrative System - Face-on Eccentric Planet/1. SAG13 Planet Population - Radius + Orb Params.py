...
Generates a single long-period, nearly face-on planet on an eccentric orbit 
around one star (the first entry of HWO Stars.csv). This illustrative system 
is used for Figure 3 (uniform vs adaptive cadence demo).

Output:
    1. Planet Catalog.csv

Notes:
- Fixed planet parameters (Rp=1 R_E, P=2 yr, ecc=0.2, inc=25.8).
