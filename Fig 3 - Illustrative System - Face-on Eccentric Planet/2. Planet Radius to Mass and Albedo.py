...
- Geometric albedos, either Earth-like (default here) or mass-class based.
...
Notes:
- This is for the demo longer-period, slightly eccentric and inclined system in Fig. 3.
- By default, albedos are Earth-like for visualization.
