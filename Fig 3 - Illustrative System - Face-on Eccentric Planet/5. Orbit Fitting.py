...
Outputs:
    fig3a_OrbitalFit_SC.png           # If "3. Observing Log.csv" is used

    OR

    fig3b_OrbitalFit_AC.png           # If "4. Observing Log.csv" is used
"""
...
if OBS_LOG_FILE[0] == '3':
    ...
    SAVE_PATH = "fig3a_OrbitalFit_SC"

elif OBS_LOG_FILE[0] == '4':
    FIG_TITLE = "Adaptive Cadence"
    SAVE_PATH = "fig3b_OrbitalFit_AC"
