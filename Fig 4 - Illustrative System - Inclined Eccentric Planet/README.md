...
The scripts generate a planet with `R = 1 R_E`, `P = 2 yr`, `e = 0.2` and `i = 88 deg` around `HD 72905 (M = 1.08 M_sol)`

## Files
- `5. Orbit Fitting.py`       -- Script to generate Fig 4a or 4b, depending on the choice of observing log in the script.
