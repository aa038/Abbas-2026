...
- The results of all these scripts are provided as data products in the directory `Data/Part I - Observing Cadence`. `HZ Probability vs Time.py` references these and can thus be run directly to reproduce Fig 6.
