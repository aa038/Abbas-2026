...
Input:
    Data/Part II - Demographics/5. Fiducial Case - IWA - 0.06, Contrast = 1e-10/5b. 4D Tongue Plot.npz  # The 4D tongue plot data file for the fiducial IWA/CF
...
Output:
    fig7_TonguePlot-w-Planets      # Matches Fig 7
"""
...
contour_label = {1: '1 star'}    # Going the extra mile to write "1 star" instead of "1 stars" resulting from only the line below. My mum taught English and Comp Litt. I wouldn't hear the end of it
...
plt.savefig(curr_dir / 'fig7_TonguePlot-w-Planets.png', dpi=300, bbox_inches='tight')