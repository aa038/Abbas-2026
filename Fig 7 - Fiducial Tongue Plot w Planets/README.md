...
## Files
- `Plot Planets on Tongue Plot.py`  -- Script to generate Fig 7
- `fig7_TonguePlot-w-Planets.png` -- Output figure (matches Fig 7 in the paper).
...
- The results of all these scripts are provided as data products in the directory `Data/Part II - Demographics/5. Fiducial Case - IWA - 0.06, Contrast = 1e-10`. `Plot Planets on Tongue Plot.py` references these and can thus be run directly to reproduce Fig 7.
...
```bash
python "Fig 7 - Fiducial Tongue Plot w Planets/Plot Planets on Tongue Plot.py"
```
This will regenerate `fig7_TonguePlot-w-Planets.png`