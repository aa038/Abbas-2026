...
Inputs:
Result of the adaptive and uniform cadence runs

    1. AC Observing Log - 1e-10.csv

    OR

    5a. Observing Log.csv (From Data / Part II - Demographics / 5. Fiducial Case - IWA - 0.06, Contrast = 1e-10) 
...
A multi-index dataframe with the orbit fits [Indices --> PlanetID, Epoch: Each planet at each observational epoch] stored as a .pkl file
    ...
    2. {Cadence Name} Fits - {Contrast Floor}.pkl
...
# >>>>>>>>>>>>>>>>>>>>>>>>>>>> USER-TUNABLE LIMITS <<<<<<<<<<<<<<<<<<<<<<<<<< #
obs_log_file = "1. AC Observing Log - 1e-10.csv"   # Observing Log from Part 2/3

output_file_name = "2. AC Orbit Fits.pkl"
#output_file_name = "4. UC Fits - 4e-11.pkl"
#output_file_name = "4. AC Fits - 2.5e-11.pkl"
#output_file_name = "4. AC Fits - 4e-11.pkl"

cadence_name  = "AC: 3 months, C: 1e-10"
