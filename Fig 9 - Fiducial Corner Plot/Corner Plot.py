...
Output:
    fig9_CornerPlot.png         # Corner plot for the posteriors
"""
...
fig.legend(handles=legend_elements, bbox_to_anchor=(0.85, 0.85), fontsize=18)
# ------------------------------------------------------------------------------ #

plt.savefig(curr_dir / 'fig9_CornerPlot.png', dpi=300, bbox_inches='tight')
